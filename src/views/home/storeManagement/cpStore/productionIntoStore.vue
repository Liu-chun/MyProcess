  ...
  <div class="box">
    <div class="search">
      ...
      <el-row>
        <el-col :span="12">
          <!-- <div class="div">
            <span class="span">经办人：</span>
            <el-input
              v-model="agent"
              placeholder="请输入经办人"
              @blur="agentblur"
              @keyup.enter.native="agentblur"
              ref="storeLocation"
              size="small"
            >
            </el-input>
    ...
    <div class="tab">
      ...
      >
        ...
        <el-table-column prop="MATERIALID" label="物料名称" width="80">
        </el-table-column>
        <el-table-column prop="BATCHNO" label="数量" width="70">
        </el-table-column>
        <el-table-column prop="QUANTITY" width="70" label="色号">
        </el-table-column>
