  ...
  <div class="box">
    <div class="search">
      ...
      <el-row>
        <el-col :span="12"
          ><div class="div">
            <span class="span">客<span style="opacity: 0">库</span>户：</span>
            <!-- <span class="ml">：</span> -->
            <el-input
              v-model="customer"
              placeholder="请输入客户"
              @blur="customerblur"
              @keyup.enter.native="customerblur"
              ref="storeLocation"
              size="small"
            >
            </el-input></div
        ...
        <el-col :span="12">
          <div class="div">
            <span class="span ls"
              >仓<span style="opacity: 0">库</span>库：</span
            >
            <el-select
              v-model="store.status"
              placeholder="请选择"
    ...
    <div class="tab">
      ...
      >
        ...
        <el-table-column prop="MATERIALID" label="品名" width="70">
        </el-table-column>
        <el-table-column prop="BATCHNO" label="拒收数量" width="80">
        </el-table-column>
