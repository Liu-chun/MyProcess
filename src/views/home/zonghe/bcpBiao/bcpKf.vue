  ...
  <div class="box">
    ...
    <div class="tab">
      <el-table :data="list" border style="width: 100%">
        ...
        <el-table-column prop="name" label="挡车工"> </el-table-column>
        <el-table-column prop="address" label="检验员"> </el-table-column>
        <el-table-column prop="address" label="扣分情况"> </el-table-column>
      </el-table>
    </div>
    <div class="btn">
